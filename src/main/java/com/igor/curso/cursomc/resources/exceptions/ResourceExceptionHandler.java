package com.igor.curso.cursomc.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotFound(ObjectNotFoundException e, HttpServletRequest request){
		...
		StandardError erro = new StandardError(HttpStatus.NOT_FOUND.value(), "Objeto não encontrado", System.currentTimeMillis());
		return ResponseEntity.status(HttpStatus.NOT_FOUND).body(erro);
	}
	
	@ExceptionHandler(DataIntegrityException.class)
	public ResponseEntity<StandardError> integrationViolation(DataIntegrityException e, HttpServletRequest request){
